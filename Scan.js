...
function Connection(command, callback_func, str) {
    ...
    try {
            ...
            if(window.location.href.indexOf("https") === -1) {
                ...
                socket = new WebSocket("wss://" + "localhost" + ":17777/" + str, "webfxscan");
            }
...
function Connection_2(command, callback_func, str) {
    ...
    try {        
            ...
            if(window.location.href.indexOf("https") === -1) {
                socket = new WebSocket("ws://" + "localhost" + ":17776/" + str, "webfxscan");
            }
            else {
                socket = new WebSocket("wss://" + "localhost" + ":17776/" + str, "webfxscan");
            }
